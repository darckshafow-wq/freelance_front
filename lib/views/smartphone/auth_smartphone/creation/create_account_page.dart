                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: _isLoading ? null : () async {
                          ...
                          final userRole = widget.role == 'client' ? UserRole.client : UserRole.freelancer;
                          ...
                          if (success) {
                            ...
                            if (loginSuccess && context.mounted) {
                              ...
                              setState(() {
                                _isLoading = false;
                                _errorMessage = "Compte créé, mais la connexion auto a échoué.";
                              });
                            }
                          } else {
                            setState(() {
                              _isLoading = false;
                              _errorMessage = authController.errorMessage ?? "Échec de la création du compte";
                            });
                          }
                        },
