...
class _SupportViewState extends State<SupportView> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Votre message a été envoyé avec succès.'), backgroundColor: Colors.green),
        );
      }
    } catch (e) {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Centre d\'assistance', style: TextStyle(fontWeight: FontWeight.w900, color: AppColors.deepBlack)),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildField('Sujet', _subjectController, Icons.topic_outlined, 'Ex: Problème de paiement'),
          const SizedBox(height: 16),
          _buildField('Message', _contentController, Icons.edit_note_rounded, 'Détaillez votre demande ici...', maxLines: 4),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(_isSending ? 'ENVOI EN COURS...' : 'ENVOYER LE MESSAGE', 
          ...
          if (ticket.adminReply.isNotEmpty) ...[
            ...
            const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('RÉPONSE DE L\'ÉQUIPE', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 11, color: AppColors.primaryGold)),
              ],
            ),
            const SizedBox(height: 8),
